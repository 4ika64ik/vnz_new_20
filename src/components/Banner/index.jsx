      ...
      <div className="container mx-auto max-w-[1344px]">
        <div className="flex px-5 py-9 flex flex-col gap-8 sm:gap-10 md:gap-16 md:pb-0 lg:gap-20 lg:px-10 lg:pt-12 overflow-hidden">
          ...
          >
            ...
            Мечтаете о жизни в Европе? Хотите получить ВНЖ и начать новую главу в своей жизни?
            </SubHead>
            <Paragraph
              color="text-white/70"
            ...
            >
              ...
              Мы предлагаем индивидуальный подход и полное сопровождение на всех этапах процесса, начиная с оформления документов и заканчивая вашей успешной адаптацией в новой стране
            </Paragraph>
          </motion.section>
